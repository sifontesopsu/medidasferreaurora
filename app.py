...
# =========================================================
    ...
    if rol == "operador":
        ...
        selected_operator_label = st.selectbox(
            "Operador a visualizar", operadores_df["label"].tolist(), key="nombre_operador_admin"
        )
        nombre_operador = str(
            operadores_df.loc[operadores_df["label"] == selected_operator_label, "operador_codigo"].iloc[0]
        )
